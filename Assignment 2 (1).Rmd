...
x
```
create new vector called x and using rnorm function to .It create 100 random values
...
```
model, Y=−1+0.5X+ε.
 Length is 100 β0 is -1 and β1 I'd 0.5.
...
plot(x, y)
```
This plot is look linear model. x increase y also increases.
...
summary(fit)
```
 The above model gives the Predicted values
...
```
Both Regression and Linear are very slightly differ.
...
From the above summary,reject the null hypothesis “zn”, “dis”, “rad”, “black” and “medv”.
